 ...
 set sr.report_sql = "select a.client_name,a.Guarantor_name,a.Guarantor_Branch,a.client_mobile_no,a.loan_id,a.client_id,productshort_Name,a.Guarantor_mobile_no
 from
 (select cl.display_name as client_name,ifnull(go.display_name,concat(gu.firstname,'',gu.lastname)) as Guarantor_name
...
where sr.report_name like 'Loan Third Overdue Repayment Reminder'